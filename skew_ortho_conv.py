...
class SOC(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=None, bias=True, train_terms=6,
                 eval_terms=15, init_iters=50, update_iters=1, multiplier=1.0, fast_train=False):
